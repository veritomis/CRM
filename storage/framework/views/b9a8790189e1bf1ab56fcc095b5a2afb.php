...
<?php if(isset($variable)): ?>
    ...
    <h1>Variable: <?php echo e($variable); ?></h1>
<?php else: ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo e(url('/usuarios/create')); ?>" class="btn btn-success btn-sm"
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($roles[intval($item->rol)]); ?></td>
                                            <td><?php echo e($item->cotizador ? 'SI' : 'NO'); ?></td>
                                            <td><?php echo e($item->activo ? 'Activo' : 'Inactivo'); ?></td>

                                            <td>
                                                <a href="<?php echo e(url('/usuarios/' . $item->id)); ?>" title="Ver usuarios"
                                                    class="btn btn-info btn-sm" style="margin-bottom: 5px;">
                                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                                    <!-- Cambiar a la clase "fas fa-eye" para el icono de un ojo -->
                                                </a>

                                                <a href="<?php echo e(url('/usuarios/' . $item->id . '/edit')); ?>"
                                                    title="Editar Usuario" class="btn btn-sm"
                                                    style="margin-bottom: 5px;background: darkorange;">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form method="POST" action="<?php echo e(url('/usuarios' . '/' . $item->id)); ?>"
...
<?php echo $__env->make('usuarios.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Veronica\Documents\proyectos unbc\unbc crm\aplicacion1 (1)\resources\views/usuarios/index.blade.php ENDPATH**/ ?>