                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a style="margin-right: 1%;" href="<?php echo e(url('/leads_argentina/create')); ?>"
                                            ...
                                            <td>
                                                <!----<div class="row mb-3">
                                                                        <div class="col-md-4 text-center">
                                                                            <a href="<?php echo e(url('/acciones_argentina/create', ['LeadsArgentina' => $item->id])); ?>"
                                                                                class="btn btn-primary btn-sm">
                                                                                <i class="fas fa-plus"></i>
                                                                            </a>
                                                                        </div>--->
                                                <div class="col-md-4 text-center">
                                                    <a href="<?php echo e(url('/leads_argentina/' . $item->id)); ?>" title="Ver Lead"
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <a href="<?php echo e(url('/leads_argentina/' . $item->id . '/edit')); ?>"
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <form method="POST" action="<?php echo e(url('/leads_argentina' . '/' . $item->id)); ?>"
                            ...
                            <div class="col-md-4 text-center">
                                <?php if($item->cotizacion == 0): ?>
                                    <form action="<?php echo e(url('/solicitar_cotizacion/arg/' . $item->id)); ?>"
...
<?php echo $__env->make('leads_argentina.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Veronica\Documents\proyectos unbc\unbc crm\aplicacion1 (1)\resources\views/leads_argentina/index.blade.php ENDPATH**/ ?>