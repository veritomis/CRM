...
<link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@600;700&family=Work+Sans:ital,wght@0,300;0,400;1,300&display=swap" rel="stylesheet">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(url('acciones_chile')); ?>" method="post" id="orden_trabajo_form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="accion" name="accion">
                        ...
                        <option value="Llamada Telefónica" <?php echo e(old('accion') === 'phone_call' ? 'selected' : ''); ?>>Llamada Telefónica
                        </option>
                ...
                <div class="form-group row" hidden>
                    ...
                    <div class="col-md-6">
                        <input id="lead" type="text" class="form-control" name="lead" value="<?php echo e($LeadsChile); ?>"
                            readonly>
                    </div>
                </div>
...
<?php echo $__env->make('acciones_chile.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Veronica\Documents\proyectos unbc\unbc crm\aplicacion1 (1)\resources\views/acciones_chile/create.blade.php ENDPATH**/ ?>