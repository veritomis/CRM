...
<style>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="<?php echo e(url('/argentina_cotiza/' . $proyecto->id . '/verPDF')); ?>" target="_blank" 
                title="Ver PDF" class="btn btn-info btn-sm" style="margin-bottom: 5px;">
                 <i class="fas fa-eye" aria-hidden="true"></i>
             </a>
             
            <form action="<?php echo e(url('argentina_cotiza/' . $proyecto->id . '/updateproyecto')); ?>" method="post"
        ...
        for (let index = 1; index <= vueltas; index++) {
            ...
            <div id="camposEdicion" style="display: NONE;">
                ...
                <?php if($proyecto->cantidad_modulos > 1): ?>
                    <?php
                        $i = 0;
                        $proyectos = FormData::where('idconsulta', $proyecto['idconsulta'])->get();
                    ?>
...
<?php echo $__env->make('leads_argentina.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Users\Veronica\Documents\proyectos unbc\unbc crm\aplicacion1 (1)\resources\views/argentina_cotiza/editProyecto.blade.php ENDPATH**/ ?>