                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a style="margin-right: 1%;" href="{{ url('/leads_chile/create') }}"
                                class="btn btn-success btn-sm" title="Añadir nuevo Lead">
                                <i class="fa fa-plus" aria-hidden="true"></i> Agregar nuevo</a>
                                
                            <form action="{{ route('import.excel_cl') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    @foreach ($leadsPaginator as $item)
                                        ...
                                        <tr class="{{ $backgroundClass }}" style="<?php echo $color; ?>">
                                            ...
                                            <td>{{ $item->platform }}</td>
                                            <td>{{ $item->cuentanos_sobre_el_proyecto }}</td>
                                            ...
                                            <td>
                                                <!----<div class="row mb-3">
                                                                        <div class="col-md-4 text-center">
                                                                            <a href="{{ url('/acciones_chile/create', ['LeadsChile' => $item->id]) }}"
                                                                                class="btn btn-primary btn-sm">
                                                                                <i class="fas fa-plus"></i>
                                                                            </a>
                                                                        </div>--->
                                                <div class="col-md-4 text-center">
                                                    <a href="{{ url('/leads_chile/' . $item->id) }}" title="Ver Lead"
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <a href="{{ url('/leads_chile/' . $item->id . '/edit') }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <form method="POST" action="{{ url('/leads_chile' . '/' . $item->id) }}"
                            ...
                            <div class="col-md-4 text-center">
                                @if ($item->cotizacion == 0)
                                    <form action="{{ url('/solicitar_cotizacion/chl/' . $item->id) }}"
