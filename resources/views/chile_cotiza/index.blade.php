                                            ...
                                            <td
                                                ...
                                                @if ($item->tipificacion != 7)
                                                    @if ($act && $act->condiciones)
                                                        <a href="{{ url('/chile_cotiza/' . $act->id . '/mail') }}"
                                                    ...
                                                    ?>
                                                    @if ($act && $act->condiciones)
                                                        @if ($act->condiciones and $item->tipificacion != 14)
                                                            <form id="deleteForm" method="POST"
                                                                action="{{ url('/chile_cotiza' . '/' . $item->id) }}"
                                                    ...
                                                    if ($act->condiciones != "") {
                                                    ?>
                                                        <a href="{{ url('/chile_cotiza/' . $item->id . '/ver') }}"
                                                            class="btn btn-primary btn-sm d-flex align-items-center justify-content-center"
                                                            title="Ver Cotizacion"
                                                            style="margin-left: 3px; margin-bottom: 5px;">
                                                            <i class="fas fa-eye mr-2"></i>
                                                        </a>
                                                        <a href="{{ url('/chile_cotiza/' . $act->id . '/verPDF') }}"
                                                    ...
                                                    @if ($act and ($item->tipificacion != 14 and $item->tipificacion != 13))
                                                        <form action="{{ url('/chile_cotiza/' . $item->id . '/acepta') }}"
...
<form id="proyectosForm" action="{{ route('formulario2.store') }}" method="POST">
